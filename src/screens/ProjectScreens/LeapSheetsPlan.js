...
class LeapSheatsPlan extends React.Component {
    static navigationOptions = {
        header: null
    }
    render() {
        const fromLeapHeader = this.props.navigation.getParam('fromLeapHeader')
        return (
            <Container style={ProjectStyles.container}>
                <ImageBackground source={require('../../images/background.png')} style={ProjectStyles.rbackgroundImage}>
                    ...
                    <Content>
                        ...
                        {!fromLeapHeader && <Button
                            full
                            transparent
                            style={styles.beginButtonStyle}
                            onPress={() => this.props.navigation.navigate('CompetencyLeapScreen', {
                                competencyId: this.props.navigation.getParam('competencyId'),
